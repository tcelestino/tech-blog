...
Como vocês já devem ter notado, recentemente o [**Elo7**](https://www.elo7.com.br) passou a ser servido **unicamente em _HTTPS_**. Nenhuma parte de nosso conteúdo ou navegação está mais disponível em _HTTP_ plano. Isso segue uma tendência de toda a Internet e cada vez mais sites devem adotar esse "formato". O gráfico abaixo ([extraído daqui](https://www.troyhunt.com/https-adoption-has-reached-the-tipping-point/)) mostra o crescimento do uso de _HTTPS_ entre os 1 milhão de sites mais acessados listados pela [_Alexa_](http://www.alexa.com/).
